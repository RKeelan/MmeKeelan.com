...
/** The number line runs from zero to this, and every answer lands on it. */
export const LINE_END = 10;

/**
 * Every problem with single-digit operands whose answer lands on the number
 * line. Zero is never an operand, since a jump of nothing teaches nothing.
 * Nor is `n − n` a subtraction: there are nine of them, a fifth of the pool,
 * and every one lands on zero.
