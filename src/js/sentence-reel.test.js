  ...
  beforeEach(() => {
    ...
    mockDocument = {
      getElementById: vi.fn((id) => {
        switch (id) {
          case 'subject-reel':
            return mockElements.subjectReel;
          case 'verb-reel':
            return mockElements.verbReel;
          case 'object-reel':
            return mockElements.objectReel;
          case 'language-toggle':
            return mockElements.languageToggle;
          case 'timer':
            return mockElements.timerDisplay;
          case 'spin-button':
            return mockElements.spinButton;
          default:
            return null;
        }
      }),
